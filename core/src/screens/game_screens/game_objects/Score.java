...
public class Score {
    ...
    public static Vector2 positionCornerScore = new Vector2(605, 589);

    public static Sprite cornerWords = GameAssets.corner;
    public static Vector2 positionCornerWords = new Vector2(605, 551);

    public static Vector2 sizeCorner = new Vector2(105, 45);
    ...
    public static void draw(CrazyWriterGame game, short writeWords, long score) {
        ...
        game.font.draw(game.batch, "Words: "+ writeWords, positionCornerScore.x+1, positionCornerScore.y+35);
        game.font.draw(game.batch, "Score: "+ score, positionCornerWords.x+1, positionCornerWords.y+35);
